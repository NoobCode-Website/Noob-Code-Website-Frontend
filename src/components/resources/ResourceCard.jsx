...
const ResourceCard = ({key , index , name , description , link , photo}) => {
  return (
    <div className="resource-card flex flex-col h-[620px] items-center min-[360px]:w-[300px] md:w-[680px] xl:w-[400px] hover:scale-105 duration-500 cursor-default border-2 border-blue-400  gap-5 rounded-xl shadow-md shadow-blue-200 p-6">
      <div>
        <img
          src={photo}
          alt=""
