    ...
    <>
      <div className="text-white flex flex-col items-center gap-8">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-10"> 
          <div>
          <a
            href="https://www.linkedin.com/company/noob-code/"
            target="blank"
          >
            <img
              alt="LinkedIn"
          ...
          <div>
          <a href="https://www.facebook.com/people/NoobCode/100094294262883/" target="blank">
            <img
              alt="Facebook"
          ...
          <div>
          <a href="https://www.instagram.com/_noobcode_/?igshid=MzRlODBiNWFlZA==" target="blank">
            <img
              alt="Instagram"
          ...
          <div>
          <a href="https://discord.com/invite/PnTpVszb2V" target="blank">
            <img
              alt="Discord"
