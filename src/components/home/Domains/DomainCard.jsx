...
const DomainCard = () => {
  return (
    <div className="flex flex-col justify-center shadow-md shadow-white hover:scale-105 duration-500 cursor-default items-center border-2 border-blue-500 xl:w-[380px] xl:h-[500px] min-[360px]:w-[300px] md:w-[600px]   rounded-xl p-6">
